...
export default function footer() {
  return (
    <div className="footer">
        <div>
            <ul>
                <li className="link-item-master">Sobre la página</li>
        ...
        <div>
            <ul>
                <li className="link-item-master">Contacto</li>
                    ...
                    <li><a href="https://www.linkedin.com/in/juan-paul-cruz-cruz-3604a9100/" target="auto_blank"><i className="fa-brands fa-linkedin-in"></i> Paul Cruz (mentor)</a></li>
            </ul>
        </div>
        <div>   
        </div>
        <div>
            <ul>
                <li className="link-item-master">Redes</li>
                <li><a href="https://www.instagram.com/okinawa1667/" target="auto_blank"><i className="fa-brands fa-instagram"></i> Diseñado por</a></li>
